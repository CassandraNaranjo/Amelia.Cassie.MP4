...
=======
#Creating title of merged data graphic
>>>>>>> 079ebdf97f29f2bebfb74903fcf70b5b96e16313
...
Ultron plot 2.0
```{r}
ggplot(data = age_of_ultron_2, aes(x = movie_id, y = ratio)) + geom_bar(color = "goldenrod3", stat = "identity", size = 1, aes(fill = gender)) +
...
```{r}
ggplot(data = infinity_wars_2, aes(x = movie_id, y = ratio)) + geom_bar(color = "goldenrod3", stat = "identity", size = 1, aes(fill = gender)) + 
    labs(title = "Top 10 Actors: Infinity War", y = "Ratio of Top Actors", caption = "Production Year: 2015") + scale_fill_manual(values = c('#e31a1c', 'darkblue'), labels = c("Female Cast", "Male Cast")) + 
  theme(axis.text.y = element_blank(), axis.ticks.y = element_blank(), axis.title.y = element_blank(), axis.text.x = element_blank(), axis.ticks.x = element_blank(), axis.title.x = element_blank(), legend.title = element_blank())
```
...
```{r}
ultron_10 <- ggplot(data = age_of_ultron_10, aes(x = movie_id, y = ratio)) +
  geom_bar(color = "goldenrod3", stat = "identity", size = 1, aes(fill = gender)) +
 labs(y = "Ratio of Top Actors", caption = "2015") + scale_fill_manual(values = c('#e31a1c', 'darkblue'), labels = c("Female Cast", "Male Cast")) + 
    theme(legend.title = element_blank(),
        axis.text = element_text(size = 15, color = "black"),
        axis.text.x = element_blank(),
        axis.title.x = element_blank(),
...
```{r}
avengers_10 <- ggplot(data = avengers_10, aes(x = movie_id, y = ratio)) +
  geom_bar(color = "goldenrod3", stat = "identity", size = 1, aes(fill = gender)) +
 labs(y = "Ratio of Top Actors", caption = "2012") + scale_fill_manual(values = c('#e31a1c', 'darkblue'), labels = c("Female Cast", "Male Cast")) + 
    theme(legend.title = element_blank(),
...
```{r}
#Creating merged data graphics
p_10 <- plot_grid(avengers_10, ultron_10, align = "v", nrow = 1, rel_widths = c(1/3.33, 1/3.33, 1/3.33))
```
