...
In addition, when looking at the top 15 lead roles, as listed by IMDB in the credits order, there is a similar discrepancy in female to male lead roles (Figure 2).This can also be seen in Endgame for when looking at the top 15 list characters on the [IMDB website](https://www.imdb.com/title/tt4154796/) for only 33 percent of them are female.
