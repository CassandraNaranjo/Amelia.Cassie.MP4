...
ggplot(data = age_of_ultron, aes(x = title, y = ratio)) +
  geom_bar(color = "gold", stat = "identity", aes(fill = gender)) +
  labs(title = "Avengers: Age of Ultron War", subtitle = "Production Year: 2015", y = "Ratio of Total Actors", x = "Gender") + scale_fill_manual(values = c('#e31a1c', '#0c2c84'), labels = c("Female Cast", "Male Cast")) + 
  theme(legend.title = element_blank())
```
